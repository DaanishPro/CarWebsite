...
import { Car, LogOut, Menu, X, Plus } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  // ✅ FIXED: Redirect to landing page on logout
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      icon: Car,
      label: "Booked Cars",
      active: activeSection === "booked-cars",
    },
    {
      id: "contact-details",
      icon: Car,
      label: "Contact Details",
      active: activeSection === "contact-details",
    },
  ]
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-8">
              {/* ✅ Realtime analytics component (without amount) */}
              <RealtimeBookingsAnalytics showAmount={false} />
            </div>
          </div>
        )
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Button className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white shadow-md">
