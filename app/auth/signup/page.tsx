  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const userData = {
        ...
        createdat: new Date().toISOString(),
        // Alias fields as requested for Realtime DB consumers
        Name: fullName.trim(),
        PhoneNo: phoneNumber.trim(),
        EmailId: user.email || "",
      } as any

      // Fire-and-forget: save to Firestore and Realtime DB without blocking navigation
      ...
      databaseUtils.saveUserData(userData).catch((dbError) => {
        console.warn("Realtime Database save failed:", dbError)
      })
      ...
      // Ensure the button doesn't stay stuck if navigation fails
